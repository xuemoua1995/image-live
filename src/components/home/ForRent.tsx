...
import CardRent from '../Card/CardRent';
...
const NewtomarketComponent = () => {
  ...
  const getProperty = useCallback(async () => {
    //const res = await APIGET('/property/?limit=8&type=2');
    ...
    <Box component={'section'}
      ...
      <div className='container'>
        <div className='new-section-header'>
          <h1 style={{marginTop:20}} className='font-subheader'>{t('home.forRent')}</h1>
        </div>
        <div>
          {isLoading ? 
          <div>
